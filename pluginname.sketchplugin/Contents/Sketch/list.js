...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = toJSArray;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_sketch_module_web_view__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__AppService_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_toJSArray__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_toLayerObject__ = __webpack_require__(7);
...
class App {
  ...
  setup(context, debug) {
    ...
    // set service
    this.service = new __WEBPACK_IMPORTED_MODULE_1__AppService_js__["a" /* default */](context);
  }
  ...
  didSearchByText(value) {
    const predicate = NSPredicate.predicateWithFormat("name CONTAINS [c] %@ ||" + "stringValue CONTAINS [c] %@", value, value);

    const layerObjects = Object(__WEBPACK_IMPORTED_MODULE_2__utils_toJSArray__["a" /* toJSArray */])(this.service.findLayer(predicate)).map(v => Object(__WEBPACK_IMPORTED_MODULE_3__utils_toLayerObject__["a" /* default */])(v));
  ...
  didSelectLayer(selectedID) {
    ...
    const predicate = NSPredicate.predicateWithFormat("objectID == %@", selectedID);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_toJSArray__ = __webpack_require__(0);
...
class AppService {
  ...
  findLayer(predicate) {
    ...
    while (page = list.nextObject()) {
      let items = page.children();
      result = result.arrayByAddingObjectsFromArray(items.filteredArrayUsingPredicate(predicate));
    }
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = toLayerObject;
function toLayerObject(layer) {
  log("#toLayerObject");
